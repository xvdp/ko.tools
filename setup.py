...
def _readme():
    with open(_path('README.md'), 'r', encoding='utf8') as _fo:
        return _fo.read()

def _requirements():
    with open(_path('requirements.txt'), 'r', encoding='utf8') as _fo:
        return _fo.read().split()

def _set_version(version):
    with open(_path('koreto','version.py'), 'w', encoding='utf8') as _fi:
